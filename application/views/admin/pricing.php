...
<section class="col-lg-10 connectedSortable">
                            ...
                            <div class="box box-primary">
                                ...
                                <a href="<?= base_url(); ?>admin_pricing/tambah" class="btn btn-primary"><i class="fa fa-plus-circle"> Tambah Pricing Plan</i></a>
                                    <br><br>
                                    <?= $this->session->flashdata('save_pricing'); ?>
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $p['nama_paket'] ?></td>
                                            <td><?= $p['judul'] ?></td>
                                            <td align="center"><a href="<?= base_url() ?>services" class="btn  btn-warning" target="_blank"><i class="fa  fa-align-center"></i> <span> Lihat Isi Pricing Plan</span></button></td>
                                            <td><?= $p['harga'] ?></td>
                                            <td><a href="<?php echo base_url();?>admin_Pricing/edit/<?=$p['id']?>"><button class="btn bg-blue btn-block btn-circle"><i class="fa fa-edit"></i></button></a></td>
                                            <td><a onclick="return confirm('Yakin ingin menghapus Pricing Plan ini...?')" href="<?php echo base_url();?>admin_Pricing/hapus/<?=$p['id']?>"><button class="btn bg-red btn-block btn-circle"><i class="fa fa-trash-o"></i></button></a></td>
                                        </tr>
                                        <?php endforeach ?>
                                    </table>
