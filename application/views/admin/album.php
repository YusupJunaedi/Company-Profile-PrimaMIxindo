...
<section class="col-lg-8 connectedSortable">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">
                                        Data Album Dokumentasi
                                    </h3>
                                </div>
                              
                                
                                <div class="box-footer">
                                <a href="<?= base_url(); ?>admin_album/tambah" class="btn btn-primary"><i class="fa fa-plus-circle"> Tambah Data Album</i></a>
                                    <br><br>

                                <?= $this->session->flashdata('save_album'); ?>
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $a['nama_album'] ?></td>
                                            <td align="center"><a href="<?= base_url() ?>assets/file/album/<?= $a['sampul_album'] ?>" class="btn  btn-warning" target="_blank"><i class="fa  fa-picture-o"></i> <span> Lihat Photo Album</span></button></td>
                                            <td><a href="<?php echo base_url();?>admin_album/edit/<?=$a['id']?>"><button class="btn bg-blue btn-block btn-circle"><i class="fa fa-edit"></i></button></a></td>
                                            <td><a onclick="return confirm('Yakin ingin menghapus Album ini...?')" href="<?php echo base_url();?>admin_album/hapus/<?=$a['id']?>"><button class="btn bg-red btn-block btn-circle"><i class="fa fa-trash-o"></i></button></a></td>
