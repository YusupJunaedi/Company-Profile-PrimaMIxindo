                                ...
                                <div class="box-footer">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $r['positive'] ?></td>
                                            <td><?= $r['followers'] ?></td>
                                            <td align="center"><a href="<?php echo base_url();?>admin_reputasi/edit/<?=$r['id']?>"><button class="btn bg-blue btn-block btn-circle"><i class="fa fa-edit"></i></button></a></td>
                                        </tr>
                                        <?php endforeach ?>
                                    </table>
