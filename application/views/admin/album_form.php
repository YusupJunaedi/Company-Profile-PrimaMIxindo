...
<section class="col-lg-8 connectedSortable">
                            ...
                            <div class="box box-primary">
                                ...
                                <form action="<?php echo base_url();?>admin_album/save" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_album" value="<?=$nama_album ?>"/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->


                                    <div class="form-group">
                                        <label>Sampul Album</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-file-o"></i>
                                            </div>
                                           <input type="file" class="btn btn-primary" name="sampul_album" required="">
                                        </div><!-- /.input group -->
